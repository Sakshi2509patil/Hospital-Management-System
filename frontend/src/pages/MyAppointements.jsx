...
//               <p><span>Date & Time:</span>2, Jun, 2025 |  8:30 PM</p>
//             </div>
//             <div></div>
//             <div>
...
//     try{
//       const{data}=await axios.get(backendUrl+"/api/admin/user/appointments",{headers:{token}})
//       if(data.success){
...
//           <div
//             key={index}
//             // className="flex items-start gap-6 border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-lg transition-shadow"
//             className="flex flex-col sm:flex-row items-start gap-6 border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-lg transition-shadow"
...
//                 <span className="font-medium">Date & Time:</span> 2 Jun, 2025 | 8:30 PM
//               </p>
//             </div>
...
//                 Pay Online
//               </button>
//               <button className="bg-gray-300 text-black px-4 py-2 rounded-lg hover:bg-gray-500 transition">
//                 Cancel Appointment
//               </button>
//             </div>
//           </div>
...
//     setLoading(true)
//     try {
//       // Fixed: Use POST request as defined in your backend routes
//       const { data } = await axios.post(backendUrl + "/api/admin/user/appointments", {}, {
//         headers: { token }
//       })
