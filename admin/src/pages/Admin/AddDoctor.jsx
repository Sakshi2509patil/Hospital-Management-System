...
//                         <p>Speciality</p>
//                        <select name="" id="">
//                         <option name="General Physician">General Physician</option>
...
//                     <img className='w-16 bg-gray-100 rounded-full' src={docImg ? URL.createObjectURL(docImg) :assets.upload_area} alt="" />
//                 </label>
...
//                     <div className='flex-1 flex flex-col gap-1'>
//                         <p>Address</p>
//                         <input onChange={(e)=> setAddress1(e.target.value)} value={address1} className='border rounded px-3 py-2 mb-1' type="text" placeholder='Address1' required />
...
const AddDoctor = () => {
    ...
    const onSubmitHandler=async(event)=>{
        ...
        try{
           ...
           // Fixed console log - proper template literal syntax
           formData.forEach((value,key)=>{
             console.log(`${key}: ${value}`)
           })
